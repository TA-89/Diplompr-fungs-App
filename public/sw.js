...
// Strategie:
//  - Seitenaufrufe (HTML): zuerst Netz, bei Offline aus dem Cache.
...
self.addEventListener('fetch', (event) => {
  ...
  // Navigationen: Netz zuerst, dann Cache (zeigt Updates, funktioniert offline)
